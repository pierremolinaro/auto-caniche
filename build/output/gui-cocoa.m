...
static const UInt16 * gPopUpData_0_lexicalAnalyzer [1] = {
  NULL
} ;
...
@interface OC_Tokenizer_0_lexicalAnalyzer : OC_Lexique_lexicalAnalyzer {
...
@implementation OC_Tokenizer_0_lexicalAnalyzer
...
- (const UInt16 * *) popupListData {
  return gPopUpData_0_lexicalAnalyzer ;
}
...
OC_Lexique * tokenizerForExtension (const NSString * inExtension) {
  ...
  if ([inExtension isEqualToString:@"omnibus"]) {
    result = [OC_Tokenizer_0_lexicalAnalyzer new] ;
  }
  return result ;
}
...
NSArray * tokenizers (void) {
  return [NSArray arrayWithObjects:
    [OC_Tokenizer_0_lexicalAnalyzer new],
    nil
  ] ;
}
